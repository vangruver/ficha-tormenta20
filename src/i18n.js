...
const DICT = {
  pt: {
    ...
    "menu.diceRoller": "🎲 Rolador de dados",
    "menu.diceRoller.title": "Rolador de dados: expressões livres (2d6+3) e os testes da ficha — funciona com ou sem sala de rolagens",
    ...
    "prefs.skin.noite": "Noite (padrão)",
    "prefs.skin.mesa": "Mesa (escuro e denso)",
    "prefs.skin.papel": "Papel Branco (claro)",
    "prefs.skin.pergaminho": "Pergaminho",
    "prefs.lang": "Idioma",
  ...
  en: {
    ...
    "menu.diceRoller": "🎲 Dice roller",
    "menu.diceRoller.title": "Dice roller: free expressions (2d6+3) plus the sheet's own checks — works with or without a room",
    ...
    "prefs.skin.noite": "Night (default)",
    "prefs.skin.mesa": "Table (dark, compact)",
    "prefs.skin.papel": "White Paper (light)",
    "prefs.skin.pergaminho": "Parchment",
    "prefs.lang": "Language",
  ...
  es: {
    ...
    "menu.diceRoller": "🎲 Tirador de dados",
    "menu.diceRoller.title": "Tirador de dados: expresiones libres (2d6+3) y las pruebas de la hoja — funciona con o sin sala",
    ...
    "prefs.skin.noite": "Noche (predeterminado)",
    "prefs.skin.mesa": "Mesa (oscuro y denso)",
    "prefs.skin.papel": "Papel Blanco (claro)",
    "prefs.skin.pergaminho": "Pergamino",
    "prefs.lang": "Idioma",
